...
include!(concat!(env!("OUT_DIR"), "/geometry_backend_sources.rs"));
...
mod m7_recovery;
#[cfg(test)]
use m7_recovery::classify_recovery;
use m7_recovery::{flatten_truth_segment, measure_boundary, recovery_refusal, run_recovery};
