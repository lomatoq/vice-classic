...
use serde::Serialize;
use vice_image::{sub, ObservationTensor, CHANNELS};
use vice_ir::{ExteriorModel, LinearRgb};

use crate::interior::{InteriorConfidence, CORE_WEIGHT};

use color::{
    coverage_amplified_interval, decode_u8, encode_u8, gamut_bounded_interval, opaque_color,
    separation_codes,
};
pub use color::{ColorHypothesis, IntervalReason};
